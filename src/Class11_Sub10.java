...
public class Class11_Sub10 extends Class11 {
    ...
    public static void method224(boolean arg0, byte[] arg1, byte arg2, int arg3, int arg4) {
        try {
            anInt1664++;
            if (arg2 != 102) aLong1663 = 14L;
            if (Class11_Sub5_Sub1.aClass15_1925 != null) {
                if (Class25.anInt470 >= 0) {
                    ...
                    if ((Class25.anInt470 ^ 0xffffffff) != -1) {
                        ...
                        Class20.anInt395 = (-1 + (Class20.anInt395 + i - -3600)) / Class20.anInt395;
                    } else Class20.anInt395 = 0;
                    ...
                    Buffer.aBoolean1575 = arg0;
                    Class8.anInt178 = arg4;
                } else Class32.method663(arg0, 0, arg4, arg1);
            }
        } catch (RuntimeException runtimeexception) {
            throw Class58.method939(runtimeexception, ("ja.S(" + arg0 + ',' + (arg1 != null ? "{...}" : "null") + ',' + arg2 + ',' + arg3 + ',' + arg4 + ')'));
        }
    }
    ...
    public static void method225(int arg0) {
        try {
            anIntArray1672 = null;
            if (arg0 != -5563) parseTrackedPlayerMovement(-51);
            aClass31_1669 = null;
    ...
    public static void parseTrackedPlayerMovement(int arg0) {
        try {
            anInt1654++;
            int i = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(8);
            if (arg0 != -918) aClass31_1669 = null;
            if (Class48.anInt885 > i) {
                for (int i_0_ = i; (i_0_ ^ 0xffffffff) > (Class48.anInt885 ^ 0xffffffff); i_0_++)
                    Class20.anIntArray394[Class64.anInt1340++] = Class32.anIntArray597[i_0_];
            }
            if ((i ^ 0xffffffff) < (Class48.anInt885 ^ 0xffffffff)) throw new RuntimeException("gppov1");
            Class48.anInt885 = 0;
            for (int i_1_ = 0; i > i_1_; i_1_++) {
                ...
                int i_3_ = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(1);
                if (i_3_ == 0) {
                    Class32.anIntArray597[Class48.anInt885++] = i_2_;
                    class11_sub10_sub4_sub2_sub1.anInt2505 = Class61.anInt1283;
                } else {
                    int i_4_ = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(2);
                    if ((i_4_ ^ 0xffffffff) == -1) {
                        Class32.anIntArray597[Class48.anInt885++] = i_2_;
                        class11_sub10_sub4_sub2_sub1.anInt2505 = Class61.anInt1283;
                        Class54.anIntArray1066[Class11_Sub11.anInt1687++] = i_2_;
                    } else if ((i_4_ ^ 0xffffffff) == -2) {
                        Class32.anIntArray597[Class48.anInt885++] = i_2_;
                        class11_sub10_sub4_sub2_sub1.anInt2505 = Class61.anInt1283;
                        int i_5_ = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(3);
                        class11_sub10_sub4_sub2_sub1.method273(i_5_, (byte) 68, false);
                        int i_6_ = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(1);
                        if ((i_6_ ^ 0xffffffff) == -2) Class54.anIntArray1066[Class11_Sub11.anInt1687++] = i_2_;
                    } else if (i_4_ == 2) {
                        Class32.anIntArray597[Class48.anInt885++] = i_2_;
                        class11_sub10_sub4_sub2_sub1.anInt2505 = Class61.anInt1283;
                        int i_7_ = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(3);
                        class11_sub10_sub4_sub2_sub1.method273(i_7_, (byte) 68, true);
                        int i_8_ = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(3);
                        class11_sub10_sub4_sub2_sub1.method273(i_8_, (byte) 68, true);
                        int i_9_ = Class11_Sub10_Sub4_Sub2.inBuffer.readBits(1);
                        if (i_9_ == 1) Class54.anIntArray1066[Class11_Sub11.anInt1687++] = i_2_;
                    } else if (i_4_ == 3) Class20.anIntArray394[Class64.anInt1340++] = i_2_;
                }
            }
        } catch (RuntimeException runtimeexception) {
    ...
    static {
        aBoolean1653 = true;
        anInt1655 = 1;
        aClass31_1669 = Class64.method992("and choose the (Wcreate account(W", 255);
        aLong1663 = 0L;
        anInt1665 = 50;
