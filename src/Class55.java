...
public abstract class Class55
{
    ...
    public static Class31 aClass31_1113
	= Class64.method992("overlay_multiway", 255);
	...
	try {
		...
		if (aByteArrayArrayArray1118[i] != null) {
		    for (int i_0_ = 0;
			 aByteArrayArrayArray1118[i].length > i_0_; i_0_++)
    ...
    public static void method877(boolean arg0, int arg1) {
	try {
	    anInt1122++;
		...
		boolean bool = false;
		if (((i_7_ / 8 ^ 0xffffffff) == -49
		     || (i_7_ / 8 ^ 0xffffffff) == -50)
		    && i_4_ / 8 == 48)
		    bool = true;
		if (i_7_ / 8 == 48 && (i_4_ / 8 ^ 0xffffffff) == -149)
		    bool = true;
		...
		i_1_ = 0;
		for (int i_8_ = (-6 + i_7_) / 8; i_8_ <= (i_7_ + 6) / 8;
		     i_8_++) {
		    for (int i_9_ = (-6 + i_4_) / 8; i_9_ <= (6 + i_4_) / 8;
			 i_9_++) {
			int i_10_ = i_9_ + (i_8_ << -1377476536);
			if (!bool
			    || (i_9_ != 49 && (i_9_ ^ 0xffffffff) != -150
				&& (i_9_ ^ 0xffffffff) != -148 && i_8_ != 50
				&& ((i_8_ ^ 0xffffffff) != -50
				    || (i_9_ ^ 0xffffffff) != -48))) {
			    Class11_Sub10_Sub4_Sub3.anIntArray2589[i_1_]
				= i_10_;
			    Class11_Sub10_Sub4_Sub1.anIntArray2490[i_1_]
				= (Class13.aClass55_Sub1_270.method899
				   ((byte) -18,
				    (Class40.method744
				     (Class11_Sub12.method494(arg1, -50),
				      (new Class31[]
				       { Class59.aClass31_1235,
					 Class11_Sub11.method493(i_8_,
								 (byte) -124),
					 Class51.aClass31_1015,
					 (Class11_Sub11.method493
					  (i_9_, (byte) -125)) })))));
			    Canvas_Sub1.anIntArray64[i_1_]
				= (Class13.aClass55_Sub1_270.method899
				   ((byte) -18,
				    (Class40.method744
				     (0,
		...
		int i_15_ = ((-(Class11_Sub10_Sub4_Sub2.inBuffer
				.position)
			     ...
			     / 16);
		Class11_Sub10_Sub4_Sub5.anIntArrayArray2678
		    = new int[i_15_][4];
		for (int i_16_ = 0;
		     (i_16_ ^ 0xffffffff) > (i_15_ ^ 0xffffffff); i_16_++) {
		...
		for (int i_22_ = 0; i_22_ < 4; i_22_++) {
			...
			for (int i_24_ = 0; i_24_ < 13; i_24_++) {
			    int i_25_ = (anIntArrayArrayArray1092[i_22_][i_23_]
					 [i_24_]);
			    if (i_25_ != -1) {
				int i_26_ = 0x3ff & i_25_ >> 429733134;
				int i_27_ = (i_25_ & 0x3ffc) >> -2054250109;
				int i_28_
				    = (i_26_ / 8 << -917639992) + i_27_ / 8;
				for (int i_29_ = 0;
				     ((i_15_ ^ 0xffffffff)
				      < (i_29_ ^ 0xffffffff));
				     i_29_++) {
				    if (i_28_ == (Class11_Sub10_Sub4_Sub3
						  .anIntArray2589[i_29_])) {
					i_28_ = -1;
					break;
				    }
				}
				if (i_28_ != -1) {
				    Class11_Sub10_Sub4_Sub3.anIntArray2589
					[i_15_]
					= i_28_;
				    int i_30_
					= (0xffc4 & i_28_) >> -1025223800;
				    int i_31_ = 0xff & i_28_;
				    Class11_Sub10_Sub4_Sub1.anIntArray2490
					[i_15_]
					= (Class13.aClass55_Sub1_270.method899
					   ((byte) -18,
					    (Class40.method744
						 ...
						 (Class11_Sub11.method493
						  (i_31_, (byte) -125)) })))));
				    Canvas_Sub1.anIntArray64[i_15_]
					= (Class13.aClass55_Sub1_270.method899
					   ((byte) -18,
					    (Class40.method744
					     (0,
	...
	try {
	    anInt1090++;
	    if ((arg0 ^ 0xffffffff) > arg2
		|| ((aByteArrayArrayArray1118.length ^ 0xffffffff)
		    >= (arg0 ^ 0xffffffff))
		|| aByteArrayArrayArray1118[arg0] == null || arg1 < 0
		|| ((arg1 ^ 0xffffffff)
		    <= (aByteArrayArrayArray1118[arg0].length ^ 0xffffffff)))
		return null;
	...
	try {
	    ...
	    if (arg0 >= -111)
		return null;
	    if (aByteArrayArrayArray1118.length == 1)
		return method879(0, arg1, -1);
	    if ((aByteArrayArrayArray1118[arg1].length ^ 0xffffffff) == -2)
		return method879(arg1, 0, -1);
	...
	try {
	    anInt1117++;
	    if (arg2 < 0 || aByteArrayArrayArray1118.length <= arg2
		|| aByteArrayArrayArray1118[arg2] == null
		|| (arg1 ^ 0xffffffff) > -1
		|| aByteArrayArrayArray1118[arg2].length <= arg1)
		return false;
	    if (arg0 != 50)
		aClass31_1139 = null;
	    if (aByteArrayArrayArray1118[arg2][arg1] != null)
		return true;
	    if (aByteArrayArray1102[arg2] != null)
		return true;
	...
	try {
	    anInt1110++;
	    if ((aByteArrayArrayArray1118.length ^ 0xffffffff) == -2)
		return method887((byte) -123, arg1, 0);
	    if (arg0 != 0)
		anInt1098 = 1;
	    if (aByteArrayArrayArray1118[arg1].length == 1)
		return method887((byte) -124, 0, arg1);
	    throw new RuntimeException();
	} catch (RuntimeException runtimeexception) {
	    throw Class58.method939(runtimeexception,
				    "ud.HA(" + arg0 + ',' + arg1 + ')');
	...
	if ((i ^ 0xffffffff) == -6) {
		...
		if (i_32_ < anIntArray1105[i_35_])
		    i_32_ = anIntArray1105[i_35_];
	    }
		...
		for (int i_36_ = 0; anInt1104 > i_36_; i_36_++)
		    anIntArray1101[anIntArray1105[i_36_]]
			= buffer.method188((byte) 105);
		aClass25_1100 = new Class25(anIntArray1101);
	    }
	    for (int i_37_ = arg1; i_37_ < anInt1104; i_37_++)
		anIntArray1135[anIntArray1105[i_37_]]
		    = buffer.method188((byte) 105);
	    for (int i_38_ = 0;
		 (i_38_ ^ 0xffffffff) > (anInt1104 ^ 0xffffffff); i_38_++)
		anIntArray1088[anIntArray1105[i_38_]]
		    = buffer.method188((byte) 105);
	    for (int i_39_ = 0; anInt1104 > i_39_; i_39_++)
		anIntArray1124[anIntArray1105[i_39_]]
		...
		for (int i_44_ = 0; i_43_ > i_44_; i_44_++) {
		    int i_45_ = (anIntArrayArray1099[i_41_][i_44_] = i_33_
				 += (buffer.method164
				     (Class11_Sub12.method494(arg1, 127))));
		    if (i_45_ > i_42_)
			i_42_ = i_45_;
		}
		...
		for (int i_46_ = 0;
		     (anInt1104 ^ 0xffffffff) < (i_46_ ^ 0xffffffff);
		     i_46_++) {
		    int i_47_ = anIntArray1105[i_46_];
		    int i_48_ = anIntArray1124[i_47_];
		    anIntArrayArray1128[i_47_]
			= new int[aByteArrayArrayArray1118[i_47_].length];
		    for (int i_49_ = 0; i_48_ > i_49_; i_49_++)
			anIntArrayArray1128[i_47_][(anIntArrayArray1099[i_47_]
						    [i_49_])]
			    = buffer.method188((byte) 105);
		    aClass25Array1123[i_47_]
			= new Class25(anIntArrayArray1128[i_47_]);
		}
	    }
	}
    }
	...
	try {
	    if (arg0 >= -115)
		method883(-122, 49, -126);
	    anInt1120++;
	    return method901(arg1, arg2, null, 115);
	} catch (RuntimeException runtimeexception) {
	    throw Class58.method939(runtimeexception,
				    ("ud.OA(" + arg0 + ',' + arg1 + ',' + arg2
				     + ')'));
	}
    }
	...
	try {
	    ...
	    int i_50_
		= aClass25Array1123[i].method596(-74, arg2.method644(107));
	...
	try {
	    ...
	    return aClass25Array1123[arg2].method596(-100,
						     arg1.method644(-105));
	} catch (RuntimeException runtimeexception) {
	    throw Class58.method939(runtimeexception,
				    ("ud.U(" + arg0 + ','
	...
	try {
	    ...
	    int i_51_
		= aClass25Array1123[i].method596(-62, arg0.method644(-119));
	...
	try {
		...
		return true;
	    byte[] is_54_;
	    if (arg2 != null && (arg2[0] != 0 || arg2[1] != 0
				 || (arg2[2] ^ 0xffffffff) != -1
				 || (arg2[3] ^ 0xffffffff) != -1)) {
		is_54_ = new byte[aByteArrayArray1102[arg0].length];
		Class21.method574(aByteArrayArray1102[arg0], 0, is_54_, 0,
				  is_54_.length);
		Buffer buffer = new Buffer(is_54_);
		buffer.method144(buffer.payload.length, 8,
				       arg2, 5);
	    } else
		is_54_ = aByteArrayArray1102[arg0];
	    byte[] is_55_;
	    try {
		is_55_ = Class46.method782((byte) 95, is_54_);
	    } catch (RuntimeException runtimeexception) {
		throw Class58.method939
			  (runtimeexception,
			   ("T3 - " + (arg2 != null) + "," + arg0 + ","
			    + is_54_.length + ","
			    + Buffer.method186(is_54_.length, is_54_,
						     true)
			    + ","
		...
		for (int i_59_ = 0; i_59_ < i_57_; i_59_++) {
		    int i_60_ = 0;
		    for (int i_61_ = 0;
			 (i ^ 0xffffffff) < (i_61_ ^ 0xffffffff); i_61_++) {
		...
		for (int i_62_ = 0; (i ^ 0xffffffff) < (i_62_ ^ 0xffffffff);
		     i_62_++) {
		    if (is_52_[is[i_62_]] == null)
			is_52_[is[i_62_]] = new byte[is_58_[i_62_]];
		    is_58_[i_62_] = 0;
		}
		buffer.position = i_56_;
		int i_63_ = 0;
		for (int i_64_ = 0; i_57_ > i_64_; i_64_++) {
		    int i_65_ = 0;
		    for (int i_66_ = 0;
			 (i ^ 0xffffffff) < (i_66_ ^ 0xffffffff); i_66_++) {
			i_65_ += buffer.method188((byte) 105);
			Class21.method574(is_55_, i_63_, is_52_[is[i_66_]],
					  is_58_[i_66_], i_65_);
			is_58_[i_66_] += i_65_;
			i_63_ += i_65_;
		    }
    ...
    public static Class11_Sub10_Sub13_Sub3 method896
	(Class55 arg0, boolean arg1, Class31 arg2, Class31 arg3) {
	try {
	    if (arg1 != true)
		return null;
	    anInt1131++;
    ...
    public static Class11_Sub10_Sub13_Sub4[] method898(Class55 arg0, int arg1,
						       int arg2, int arg3) {
	try {
	    anInt1136++;
	    if (!Class37_Sub1.method714(arg1, -29446, arg0, arg3))
		return null;
	    if (arg2 != 0)
		method877(false, -103);
	...
	try {
		...
		anIntArray1135 = null;
	    anInt1134++;
	    if (arg1 < 0 || aByteArrayArrayArray1118.length <= arg1
		|| aByteArrayArrayArray1118[arg1] == null || arg0 < 0
		|| ((aByteArrayArrayArray1118[arg1].length ^ 0xffffffff)
		    >= (arg0 ^ 0xffffffff)))
		return null;
	    ...
	    if (aBoolean1108)
		aByteArrayArrayArray1118[arg1][arg0] = null;
	    return is;
	} catch (RuntimeException runtimeexception) {
	    throw Class58.method939(runtimeexception,
				    ("ud.GA(" + arg0 + ',' + arg1 + ','
