...
public class Class54 {
    ...
    public static void method871(int arg0, int arg1, boolean arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        anInt1075++;
        if ((arg1 ^ 0xffffffff) <= -2 && (arg3 ^ 0xffffffff) <= -2 && arg1 <= 102 && (arg3 ^ 0xffffffff) >= -103) {
            if (Class1.aBoolean94 && Class1.anInt82 != arg5) return;
            int i = 0;
            int i_0_ = -1;
            if (arg0 == 0) i = Class52.aClass49_1024.method842(arg5, arg1, arg3);
            boolean bool = false;
            if ((arg0 ^ 0xffffffff) == -2) i = Class52.aClass49_1024.method802(arg5, arg1, arg3);
            if (arg0 == 2) i = Class52.aClass49_1024.method812(arg5, arg1, arg3);
            boolean bool_1_ = false;
            if ((arg0 ^ 0xffffffff) == -4) i = Class52.aClass49_1024.method841(arg5, arg1, arg3);
            if ((i ^ 0xffffffff) != -1) {
                i_0_ = i >> 883927118 & 0x7fff;
                int i_2_ = Class52.aClass49_1024.method832(arg5, arg1, arg3, i);
                int i_3_ = i_2_ >> 697110630 & 0x3;
                int i_4_ = 0x1f & i_2_;
                if ((arg0 ^ 0xffffffff) == -1) {
                    Class52.aClass49_1024.method822(arg5, arg1, arg3);
                    Class11_Sub10_Sub2 class11_sub10_sub2 = Class51.method853((byte) -107, i_0_);
                    if (class11_sub10_sub2.aBoolean1960)
                        Class39.aClass8Array707[arg5].method90(i_4_, (byte) -122, class11_sub10_sub2.aBoolean1969, arg3, i_3_, arg1);
                }
                if (arg0 == 1) Class52.aClass49_1024.method798(arg5, arg1, arg3);
                if (arg0 == 2) {
                    Class52.aClass49_1024.method806(arg5, arg1, arg3);
                    Class11_Sub10_Sub2 class11_sub10_sub2 = Class51.method853((byte) -124, i_0_);
                    if (arg1 + class11_sub10_sub2.anInt1967 > 103 || ((arg3 - -class11_sub10_sub2.anInt1967 ^ 0xffffffff) < -104) || ((arg1 + class11_sub10_sub2.anInt1974 ^ 0xffffffff) < -104) || ((class11_sub10_sub2.anInt1974 + arg3 ^ 0xffffffff) < -104))
                        return;
                    if (class11_sub10_sub2.aBoolean1960)
                        Class39.aClass8Array707[arg5].method87(class11_sub10_sub2.anInt1967, class11_sub10_sub2.anInt1974, i_3_, class11_sub10_sub2.aBoolean1969, arg1, -1, arg3);
                }
                if (arg0 == 3) {
                    Class52.aClass49_1024.method796(arg5, arg1, arg3);
                    Class11_Sub10_Sub2 class11_sub10_sub2 = Class51.method853((byte) -125, i_0_);
                    if (class11_sub10_sub2.aBoolean1960 && (class11_sub10_sub2.anInt1998 ^ 0xffffffff) == -2)
                        Class39.aClass8Array707[arg5].method95(arg3, arg1, (byte) -32);
                }
            }
            if (arg6 >= 0) {
                int i_5_ = arg5;
                if (i_5_ < 3 && (Class25.aByteArrayArrayArray481[1][arg1][arg3] & 0x2 ^ 0xffffffff) == -3) i_5_++;
                Canvas_Sub1.method38(i_5_, arg3, arg4, Class39.aClass8Array707[arg5], arg6, Class52.aClass49_1024, (byte) 79, arg7, arg5, arg1);
            }
        }
        if (arg2 != false) anInt1080 = -31;
    }
    ...
    public static Class11_Sub10_Sub3 method873(byte arg0, int arg1) {
        try {
            anInt1077++;
            Class11_Sub10_Sub3 class11_sub10_sub3 = ((Class11_Sub10_Sub3) Class17.aClass40_334.method735((long) arg1, (byte) -72));
            if (class11_sub10_sub3 != null) return class11_sub10_sub3;
            byte[] is = Class8.aClass55_188.method887((byte) -122, arg1, 16);
            class11_sub10_sub3 = new Class11_Sub10_Sub3();
            if (is != null) class11_sub10_sub3.method249(new Buffer(is), false);
            int i = 69 / ((arg0 - 56) / 62);
            Class17.aClass40_334.method742(-121, (long) arg1, class11_sub10_sub3);
            return class11_sub10_sub3;
        } catch (RuntimeException runtimeexception) {
            throw Class58.method939(runtimeexception, "uc.C(" + arg0 + ',' + arg1 + ')');
        }
    }
    ...
    public static void method874(int arg0) {
        try {
            ...
            if (arg0 <= 125) aClass31_1086 = null;
            aClass31_1085 = null;
            aClass31_1086 = null;
    ...
    static {
        ...
        aClass31_1070 = Class64.method992(" is already on your friend list", 255);
