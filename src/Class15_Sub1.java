...
public abstract class Class15_Sub1 extends Class15
{
    ...
    public static Class31 aClass31_1750
	= Class64.method992("button near the top of that page)3", 255);
	...
	if ((arg0 & 0xf0) == 176) {
		...
		int i = arg0 & 0xf;
		if (arg1 == 7)
		    Class20.anIntArray382[i]
			= (Class20.anIntArray382[i] & 0x7f) + (arg2 << 7);
		else
		    Class20.anIntArray382[i]
			= (Class20.anIntArray382[i] & 0x3f80) + arg2;
	...
	try {
		...
		if ((Class55.anInt1143 ^ 0xffffffff) <= -101)
		    Class11_Sub10_Sub4_Sub3.method288(0, Class25.aClass31_461,
						      Class24.aClass31_454,
						      true);
		else {
		    Class31 class31 = Class15_Sub2.method553
					  (arg1, (byte) 115).method621(true);
		    ...
		    for (int i = 0; ((Buffer.anInt1573 ^ 0xffffffff)
				     < (i ^ 0xffffffff)); i++) {
	...
	try {
	    anInt1730++;
	    if (arg0 != 4)
		method548(null, null, null, (byte) 96);
	...
	do {
	    try {
		arg1 = (int) (0.5 + (Math.pow(0.1, (double) arg3 * 5.0E-4)
				     * (double) arg1));
		if (arg0 != -65)
		    anIntArray1734 = null;
		anInt1743++;
		if (arg1 == Class52.anInt1026)
		    break;
	...
	try {
	    ...
	    int i = arg0 - arg2;
	    if (i < -9)
		return Class14.aClass31_303;
	    if ((i ^ 0xffffffff) > 5)
		return Class39_Sub1.aClass31_1829;
	    if (i < -3)
		return Class36.aClass31_664;
	    if (i < 0)
		return Class39_Sub1.aClass31_1830;
	    if ((i ^ 0xffffffff) < -10)
		return Class11_Sub10_Sub7.aClass31_2155;
	    if ((i ^ 0xffffffff) < -7)
		return Class57.aClass31_1168;
	    if (i > 3)
		return Class7.aClass31_1435;
	    if ((i ^ 0xffffffff) < -1)
		return Class11_Sub10_Sub4_Sub1.aClass31_2476;
    ...
    public static int method546(int arg0, int arg1, int arg2, int arg3,
    ...
    public static void method548(Class55 arg0, Component arg1, Class55 arg2,
				 byte arg3) {
	try {
	    anInt1749++;
		...
		Class11_Sub10_Sub13.method402();
		Class11_Sub8.aClass37_1631
		    = Class44.method761(360, arg1, -8, 132);
		Class11_Sub10_Sub13.method402();
		...
		for (int i = 0; i < class11_sub10_sub13_sub4.anInt2775; i++) {
		    for (int i_10_ = 0;
			 ((class11_sub10_sub13_sub4.anInt2780 ^ 0xffffffff)
			  < (i_10_ ^ 0xffffffff));
			 i_10_++)
			is_9_[i_10_]
			    = (class11_sub10_sub13_sub4.anIntArray2776
			       [(i * class11_sub10_sub13_sub4.anInt2780
				 + (-i_10_
				    + (class11_sub10_sub13_sub4.anInt2780
				       + -1)))]);
		    for (int i_11_ = 0;
			 i_11_ < class11_sub10_sub13_sub4.anInt2780; i_11_++)
			class11_sub10_sub13_sub4.anIntArray2776
			    [i * class11_sub10_sub13_sub4.anInt2780 + i_11_]
			    = is_9_[i_11_];
		}
		...
		class11_sub10_sub13_sub4
		    = Class58.method938(Class32.aClass31_598,
					Class11_Sub10_Sub4_Sub5.aClass31_2687,
					-104, arg0);
		Class25.aClass37_464.method706(-76);
		class11_sub10_sub13_sub4.method456
		    (-128 + -(class11_sub10_sub13_sub4.anInt2780 / 2) + 382,
		     18);
		Class11_Sub4.aClass11_Sub10_Sub13_Sub3_1496
		    = Class55.method896(arg0, true,
					Class11_Sub10_Sub4_Sub5.aClass31_2687,
		...
		Class11_Sub6.aClass11_Sub10_Sub13_Sub3_1593
		    = Class55.method896(arg0, true,
					...
					(Class11_Sub10_Sub4_Sub2_Sub2
					 .aClass31_2831));
		Class11_Sub10_Sub4.aClass11_Sub10_Sub13_Sub3Array2038
		    = Class55_Sub1.method904(arg0, Class43.aClass31_775,
					     (byte) -58,
					     (Class11_Sub10_Sub4_Sub5
					      .aClass31_2687));
		Class63.aClass11_Sub10_Sub13_Sub4_1324
		    = new Class11_Sub10_Sub13_Sub4(128, 265);
		Class11_Sub10_Sub4_Sub2_Sub2.aClass11_Sub10_Sub13_Sub4_2823
		    = new Class11_Sub10_Sub13_Sub4(128, 265);
		for (int i = 0; (i ^ 0xffffffff) > -33921; i++)
		    Class63.aClass11_Sub10_Sub13_Sub4_1324.anIntArray2776[i]
			= Class25.aClass37_482.anIntArray692[i];
		for (int i = 0; (i ^ 0xffffffff) > -33921; i++)
		    Class11_Sub10_Sub4_Sub2_Sub2
			.aClass11_Sub10_Sub13_Sub4_2823.anIntArray2776[i]
			= Class54.aClass37_1081.anIntArray692[i];
		Class11_Sub10_Sub15.anIntArray2410 = new int[256];
		for (int i = 0; (i ^ 0xffffffff) > -65; i++)
		    Class11_Sub10_Sub15.anIntArray2410[i] = i * 262144;
		for (int i = 0; (i ^ 0xffffffff) > -65; i++)
		    Class11_Sub10_Sub15.anIntArray2410[64 + i]
			= 16711680 - -(i * 1024);
		for (int i = 0; i < 64; i++)
		    Class11_Sub10_Sub15.anIntArray2410[128 + i]
			= 16776960 + 4 * i;
		for (int i = 0; i < 64; i++)
		...
		if (arg3 <= -45) {
		    ...
		    if ((Class34.anInt632 ^ 0xffffffff) != -1
			&& !Class1.aBoolean94)
			Class53.method866(Class11_Sub10_Sub9.aClass31_2206,
					  (Class11_Sub10_Sub4_Sub5
					   .aClass31_2687),
					  Class47.aClass55_Sub1_876, 10, false,
					  0, Class34.anInt632, 2);
		    else
			Class53.method860(10, -98);
	...
	aClass31_1751
	    = (Class64.method992
	       ("Moderator option: Mute player for 48 hours: <ON>", 255));
	aBoolean1744 = false;
